...
public partial class HR_UserProfile_UcUserTraining : GridControlBase<HRUserTraining>
{
    ...
    {
        string proc = "HR.GetUserTrainingList";
    ...
    protected override void SetParameter(GridControlParameter p)
    {
        ...
        if (CurrentCompanyFlag == 0)
            functionId = HRUser.USER_TRAINING_BEFORE;//入职前的权限
        else
            functionId = HRUser.USER_TRAINING_AFTER;//入职后的权限
