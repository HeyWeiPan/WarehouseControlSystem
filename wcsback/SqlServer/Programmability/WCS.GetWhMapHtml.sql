...
-- Description: 
-- =============================================
drop proc WCS.GetWhMapHtml
go
CREATE PROCEDURE WCS.GetWhMapHtml
	@pWhId int,
	@pFloorNum int,
...
BEGIN	
	...
	begin
		...
		declare c_x cursor for select a.cell_num,a.celltype_code,b.celltype_name from wcs_cell a,wcs_celltype b where a.wh_id=@pWhId and a.y_num=@y and  floor_num=@pFloorNum and a.celltype_code=b.celltype_code order by x_num
		open c_x
