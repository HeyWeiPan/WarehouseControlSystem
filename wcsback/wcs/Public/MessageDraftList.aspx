<%@ Page Language="C#" MasterPageFile="~/CommonUI/MasterPage/MasterMessageList.master"
    AutoEventWireup="true" CodeFile="MessageDraftList.aspx.cs" Inherits="Public_MessageDraftList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="C2" runat="server">
    <code><a href="#" title="">草稿列表</a></code>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="C3" runat="server">
     <cc1:UcButton ID="BtnSend" runat="server" ColumnName="Send" Width="70px" onclick="BtnSend_Click"  OnClientClick="return CheckSend()" />
</asp:Content>
