...
public partial class Setup_Geography : PageBase
{
    ...
    private void RegditDetailScript()
    {
        if (!ClientScript.IsClientScriptBlockRegistered(this.GetType(), "JsScriptGeographyTree"))
        {
            ...
            dw.Url = UrlHelper.UrlBase + "/Setup/GeographyDetail.aspx";
            ...
            dw.AddUrlClientObjectParameter("ParentID", "f_getSelectedNodeID(TVOrg)");//Geo_ID                                 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            BtnCopy.OnClientClick = "copyMenu();return false;";
            BtnCut.OnClientClick = "cutMenu();return false;";
            BtnPaste.OnClientClick = "pasteMenu();return false;";
