...
public partial class MasterSetupDetail : System.Web.UI.MasterPage
{
    PageBase page = null;
    ...
    {
        BtnSubmit.OnClientClick = "if(!window.confirm('" + new RM(ResourceFile.Msg)["CONFIRMSUBMITFORM"] + "')){return false;}window.returnValue='REFRESH';";
    }
