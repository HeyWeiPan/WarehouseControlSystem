<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MapSetupHead.aspx.cs" Inherits="WCS_map_MapSetupHead" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetTableXml() {
            ...
            var whId = ddl.options[ddl.selectedIndex].value;
            var xmlVal = window.parent.window.frames[1].window.GetTableXml();//回调函数
            debugger;
            //每一格的坐标信息制成xml文件，且加密返回,即包含右上方快中各个数据的xml文件
            WsSetup.UpdateCellsType(whId, xmlVal, SaveOK, f_wserror);       //在~/App_Code/WsSetup.cs中定义
